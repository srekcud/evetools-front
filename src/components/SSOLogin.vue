<template>
  <button @click="redirectToSSO" class="sso-button" type="button">
    <img
        src="https://web.ccpgamescdn.com/eveonlineassets/developers/eve-sso-login-black-large.png"
        alt="SSO Login"
        class="sso-button-image"
    />
  </button>
</template>
